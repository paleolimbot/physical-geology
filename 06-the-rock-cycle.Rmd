...
knitr::include_graphics("https://openpress.usask.ca/app/uploads/sites/29/2017/05/Ablemans_Gorge_ripples.png")
```
...
knitr::include_graphics("https://openpress.usask.ca/app/uploads/sites/29/2017/05/pegmatite.png")
```
...
<ol>
 	<li>Earth’s internal heat, which causes material to move around in the core and mantle, driving plate tectonics.</li>
 	<li>The __hydrological cycle__- movement of water, ice, and air at the surface. The hydrological cycle is powered by the sun.</li>
</ol>
...
knitr::include_graphics("https://openpress.usask.ca/app/uploads/sites/29/2017/10/Rock-Cycle.png")
```
...
We can start anywhere we like to describe the rock cycle, but it’s convenient to start with magma. __Magma__ is melted rock located within the Earth. Rock can melt at between about 800 °C and 1300 °C, depending on the minerals in the rock, and the pressure the rock is under. If it cools slowly within the Earth (over centuries to millions of years), magma forms __intrusive igneous rocks__. If magma erupts onto the surface, we refer to it as __lava__. Lava cools rapidly on Earth's surface (within seconds to years) and forms __extrusive igneous rocks __(Figure \@ref(fig:figure-6-4)).[footnote]Remember the difference between intrusive and extrusive igneous rocks by recalling that <span style="text-decoration: underline">__IN__</span>trusive rocks form with<span style="text-decoration: underline">__IN__</span> the Earth, and __<span style="text-decoration: underline">EX</span>__trusive rocks form when lava <span style="text-decoration: underline">__EX__</span>its the Earth's crust.[/footnote]
...
knitr::include_graphics("https://openpress.usask.ca/app/uploads/sites/29/2017/10/USGS_pahoehoe.jpg")
```
...
knitr::include_graphics("https://openpress.usask.ca/app/uploads/sites/29/2017/10/Weathering_freeze_thaw_action_Spain.jpg")
```
...
knitr::include_graphics("https://openpress.usask.ca/app/uploads/sites/29/2017/10/Okotoks_dust_storm.jpg")
```
...
knitr::include_graphics("https://openpress.usask.ca/app/uploads/sites/29/2017/10/SouthSaskRiver-1024x768.jpg")
```
...
knitr::include_graphics("https://openpress.usask.ca/app/uploads/sites/29/2017/10/Fossil_Ripples_-_geograph.org_.uk_-_831746.jpg")
```
...
knitr::include_graphics("https://openpress.usask.ca/app/uploads/sites/29/2017/10/QuadraIsland_ls-1024x478.jpg")
```
...
<ol>
 	<li>What processes must take place to transform rocks into sediment?</li>
 	<li>What processes normally take place in the transformation of sediments to sedimentary rock?</li>
 	<li>What are the processes that lead to the formation of a metamorphic rock?</li>
</ol>
...
<ol>
 	<li>The rock must be exposed at surface. This means uplift and removal of overlying rocks and sediments is required. Once exposed, chemical and/or physical weathering can reduce the rock to smaller loose fragments (sediments). The sediments can be eroded and then transported by a variety of mechanisms.</li>
 	<li>Sediments are buried beneath other sediments, where pressure compacts the sediments, forcing grains closer together. Mineral cement forms around the grains, binding them to each other and into solid rock.</li>
 	<li>Rock is buried deeply in the crust and exposed to very high temperatures and pressures. Under those conditions, a new type of rock is formed when minerals undergo physical changes and chemical reactions.</li>
</ol>