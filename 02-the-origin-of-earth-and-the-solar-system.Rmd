...
1. In this image of three spectra, one is from the sun, and the other two are from galaxies. One of the galaxies is the Andromeda galaxy. Which spectrum is from Andromeda?
...
1. Astronomers looking for some of the earliest stars in the universe were surprised to find a planetary system called HIP 11952, which existed 12.8 billion years ago. This was very early in the universe's history, when stars still consisted largely of hydrogen and helium. Do you think there were terrestrial planets in this system? Why or why not?

1. Summarize the trends in size and composition of objects in the solar system.

1. What is the frost line, and what does it help to explain?

1. Why is Pluto not considered a planet?

1. What is differentiation?

1. The exoplanet Kepler-452b is within the habitable zone of its star. In our solar system, planets a similar distance from the Sun are terrestrial planets. Why can we not say for certain that Kepler-452b's distance from its star means it is a terrestrial planet?

1. Of the planetary systems discovered thus far, none are exactly like our solar system. Does this mean our solar system is unique in the universe?
