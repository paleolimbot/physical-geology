...
- The mechanism of the failure is the most important characteristic of a slope failure. There are three main mechanisms of slope failure:
- Fall: in falls, the material falls through the air, either vertically or nearly vertically,
- Slide: in slides, the material moves as a coherent mass along a sloping surface (with little to no internal motion within the mass), and
...
tibble::tibble(
  ...
  `Type of Material` = c(
    "Rock fragments",
    "A large rock body", "A large rock body that slides and then breaks into small fragments",
    "Soil or other overburden; in some cases, mixed with ice", "Thick deposits (m to 10s of m) of unconsolidated sediment",
    "Loose sediment with a significant component of silt and clay",
    "Sand, gravel, and larger fragments"
  ), 
  `Type of Motion` = c(
    "Vertical or near-vertical fall (plus bouncing in many cases)",
    "Motion as a unit along a planar surface (translational sliding)",
    "Flow (at high speeds, the mass of rock fragments is suspended on a cushion of air)",
    "Flow (although sliding motion may also occur)", 
    "Motion as a unit along a curved surface (rotational sliding)",
    "Flow (a mixture of sediment and water moves down a channel)",
    "Flow (similar to a mudflow, but typically faster)"
  ),
  `Rate of Motion` = c(
    "Very fast (>10s m/s)",
    "Typically very slow (mm/y to cm/y), but some can be faster",
    "Very fast (>10s m/s)", 
    "Very slow (mm/y to cm/y)", 
    "Slow (cm/y to m/y)",
    "Moderate to fast (cm/s to m/s)", "Fast (m/s)"
  )
) %>% 
  knitr::kable(
    caption = "Classification of slope failures based on type of material and motion. _Source: Steven Earle (2015) CC BY 4.0. [View source](https://opentextbc.ca/geology/)_"
  )
```

### Rock Fall

Rock fragments can break off relatively easily from steep bedrock slopes, most commonly due to frost-wedging. If you ever hike along a steep mountain trail on a cool morning, you will probably hear the occasional fall of rock fragments onto a __talus slope.__ Water in the cracks in the rock freezes and expands overnight, and this can break the rock apart. When the ice thaws in the morning sun, some of these broken fragments will fall to the slope below (Figure \@ref(fig:figure-15-7)). Talus slopes form from this fallen rock, forming slopes at the angle of repose below high rock walls (Figure \@ref(fig:figure-15-8), left). They are also known as scree slopes.
...
```{r, out.width="50%", fig.cap="_Source of images: Steven Earle (2015) CC BY 4.0. [View source](https://opentextbc.ca/geology/)_"}
knitr::include_graphics("https://openpress.usask.ca/app/uploads/sites/29/2017/05/Classifying-Slope-Failures1.jpg")
knitr::include_graphics("https://openpress.usask.ca/app/uploads/sites/29/2017/05/Classifying-Slope-Failures2.jpg")
knitr::include_graphics("https://openpress.usask.ca/app/uploads/sites/29/2017/05/Classifying-Slope-Failures3.jpg")
knitr::include_graphics("https://openpress.usask.ca/app/uploads/sites/29/2017/05/Classifying-Slope-Failures4.jpg")
```
...
```{r, out.width="50%", fig.cap="Source: Steven Earle (2015) CC BY 4.0 [View source](https://opentextbc.ca/geology/)"}
knitr::include_graphics(
  c(
    "https://openpress.usask.ca/app/uploads/sites/29/2017/05/a-road-cut-.png",
    "https://openpress.usask.ca/app/uploads/sites/29/2017/05/a-road-cut-.png"
  )
)
```
